...
$pdf -> SetFont("times", 'B', 12);
$pdf -> Ln();
$pdf -> MultiCell(18, 0.5, utf8_decode("Recopilación de la información entre año $anio y $anio1."), 0, 'C');
...
try {
    $pdf -> graficoPDF($temp, 'Ciencias basicas', array(6, 2, 10, 10), 'Estudiantes por programa academico facultad de ciencias basicas');
    $pdf -> ln(1);
    $pdf -> SetFont("times", 'B', 12);
    ...
    $pdf -> MultiCell(15, 0.5, "Estudiantes por programa academico facultad de ciencias basicas", 0, "L");
    $pdf -> ln(7);
    $pdf -> SetFont("times", '', 12);
    $pdf -> MultiCell(15, 0.5, utf8_decode("Fisica: " . $valores[1]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Intituto interdisciplinario de las ciencias: " . $valores[4]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Tecnologia en electronia: " . $valores[3]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Quimica: " . $valores[2]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Biologia: " . $valores[0]));
} catch(Exception $e) {
...
$temp = array('Ingenieria civil' => array($valores[0], 'red'), 'Ingenieria de sistemas y computación' => array($valores[1], 'blue'), 'Ingenieria electronica' => array($valores[2], 'green'), 'Tecnologia en obras civiles' => array($valores[4], 'white'), 'Tecnologia en topografia' => array($valores[3], 'pink'));
try {
    $pdf -> graficoPDF($temp, 'Ingenieria', array(6, 13, 10, 10), 'Estudiantes por programa academico facultad de ingenieria');
    $pdf -> ln(1);
    $pdf -> SetFont("times", 'B', 12);
    $pdf -> MultiCell(15, 0.5, "Estudiantes por programa academico facultad de facultad de ingenieria", 0, "L");
    $pdf -> ln(8);
    $pdf -> SetFont("times", '', 12);
    $pdf -> MultiCell(15, 0.5, utf8_decode("Ingenieria civil: " . $valores[0]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Ingenieria de sistemas y computación: " . $valores[1]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Ingenieria electronia: " . $valores[2]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Tecnologia en obras civiles: " . $valores[4]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Tecnologia en topografia: " . $valores[3]));
} catch(Exception $e) {
...
try {
    $pdf -> graficoPDF($temp, 'Ciencias de la salud', array(6, 2, 10, 10), 'Estudiantes por programa academico facultad de ciencias de la salud');
    $pdf -> ln(1);
    $pdf -> SetFont("times", 'B', 12);
    $pdf -> MultiCell(15, 0.5, "Estudiantes por programa academico facultad de facultad de ciencias de la salud", 0, "L");
    $pdf -> ln(8);
    $pdf -> SetFont("times", '', 12);
...
try {
    $pdf -> graficoPDF($temp, 'Ciencias humanas y bellas artes', array(6, 13, 10, 10), 'Estudiantes por programa academico facultad de ciencias humanas y bellas artes');
    $pdf -> ln(1);
    $pdf -> SetFont("times", 'B', 12);
    $pdf -> MultiCell(15, 0.5, "Estudiantes por programa academico facultad de facultad de ciencias humanas y bellas artes", 0, "L");
    $pdf -> ln(8);
    $pdf -> SetFont("times", '', 12);
...
try {
    $pdf -> graficoPDF($temp, 'Ciencias agroindustriales', array(6, 2, 10, 10), 'Estudiantes por programa academico facultad de ciencias agroindustriales');
    $pdf -> ln(1);
    $pdf -> SetFont("times", 'B', 12);
    $pdf -> MultiCell(15, 0.5, "Estudiantes por programa academico facultad de ciencias agroindustriales", 0, "L");
    $pdf -> ln(8);
    $pdf -> SetFont("times", '', 12);
    $pdf -> MultiCell(15, 0.5, utf8_decode("Ingenieria de alimentos: " . $valores[0]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Administración de empresas agropecuarias: " . $valores[1]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Tecnologia agropecuaria: " . $valores[2]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Tecnologia agroindustrial: " . $valores[3]));
...
try {
    $pdf -> graficoPDF($temp, 'Educacion', array(6, 13, 10, 10), 'Estudiantes por programa academico facultad de educación');
    $pdf -> ln(1);
    $pdf -> SetFont("times", 'B', 12);
    $pdf -> MultiCell(15, 0.5, "Estudiantes por programa academico facultad de educación", 0, "L");
    $pdf -> ln(8);
    $pdf -> SetFont("times", '', 12);
    $pdf -> MultiCell(15, 0.5, utf8_decode("Licenciatura en biologia: " . $valores[0]));
    $pdf -> MultiCell(15, 0.5, utf8_decode("Licenciatura en educacion fisica y deporte: " . $valores[1]));
    ...
    $pdf -> MultiCell(15, 0.5, utf8_decode("Licenciatura en matematicas: " . $valores[4]));
